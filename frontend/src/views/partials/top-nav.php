<div class="top-nav">
    ...
    <button class="theme-toggle" x-data="{ dark: window.themeManager ? window.themeManager.isDark() : false }" @click="dark = window.themeManager ? window.themeManager.toggleTheme() : false" type="button">
        ...
        <svg class="moon-icon" :style="{ display: dark ? 'none' : 'block' }" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#093C5D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
